( function ( $ ) {
  ...
  $( document ).on( 'mousedown', function ( e ) {
    ...
    if ( !$( e.target ).closest( '#searchResultsValue' ).length && !$( e.target ).is( '#searchInput' ) ) {
      $( '#searchResultsValue' ).css( 'display', 'none' );
      $( '#overlay' ).css( 'display', 'none' );
  ...
  function enableSearchNavigation( inputSelector, resultsSelector, cardSelector ) {
  ...
  enableSearchNavigation( '#searchInput', '#searchResultsValue', '.list-group-item' );
